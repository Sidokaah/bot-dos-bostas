...
module.exports = {
    ...
    run: async (client, message, args) => {
      ...
      if(args[0] == 'nikes') {
        ...
        client.db.subtract(`money_${message.guild.id}_${user.id}`, 4000)
        ...
        client.db.subtract(`money_${message.guild.id}_${user.id}`, 100000)
        message.channel.send(Embed3)
        ...
        client.db.subtract(`money_${message.guild.id}_${user.id}`, 1750000)
        message.channel.send(Embed3)
          ...
          client.db.add(`dragon_${message.guild.id}_${user.id}`, 1)
          let Embed3 = new Discord.MessageEmbed()
            .setColor("RANDOM")
            .setDescription(`<:tick:748569437589995731> Compraste uma AWP Dragon Lore por 40000 moedas!`);
          client.db.subtract(`money_${message.guild.id}_${user.id}`, 40000)
          message.channel.send(Embed3)
          ...
          client.db.add(`team_${message.guild.id}_${user.id}`, 1)
          let Embed3 = new Discord.MessageEmbed()
            .setColor("RANDOM")
            .setDescription(`<:tick:748569437589995731> Compraste um Unusual Burning Flames Team Captain por 75000 moedas!`);
          client.db.subtract(`money_${message.guild.id}_${user.id}`, 75000)
          message.channel.send(Embed3)
          ...
          client.db.add(`pc_${message.guild.id}_${user.id}`, 1)
          let Embed3 = new Discord.MessageEmbed()
            .setColor("RANDOM")
            .setDescription(`<:tick:748569437589995731> Compraste um PC Gamer por 32500 moedas!`);
          client.db.subtract(`money_${message.guild.id}_${user.id}`, 32500)
          message.channel.send(Embed3)
      } else {
