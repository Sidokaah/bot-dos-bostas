...
module.exports = {
    ...
    run: async (client, message, args) => {
      ...
      if (args[0] == 'all') {
        ...
        client.db.add(`bank_${message.guild.id}_${user.id}`, money)
        ...
        message.channel.send(embed5)
        client.db.add(`bank_${message.guild.id}_${user.id}`, args[0])
        client.db.subtract(`money_${message.guild.id}_${user.id}`, args[0])
      }
    }
}