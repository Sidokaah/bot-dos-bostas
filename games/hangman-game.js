...
class HangmanGame {
    ...
    newGame(msg) {
        ...
        const embed = new Discord.MessageEmbed()
            ...
            .addField('Letras Acertadas', '\u200b')
            .addField('Como jogar', "Reage à mensagem com emojis de letras ou que parecem letras (🅰️, 🇹, )")
            .setTimestamp();
    ...
    makeGuess(reaction) {
        ...
        if (this.inGame) {
            const editEmbed = new Discord.MessageEmbed()
                ...
                .setTitle('Jogo da Forca')
                .setDescription(this.getDescription())
                .addField('Letras Acertadas', this.guesssed.length == 0 ? '\u200b' : this.guesssed.join(" "))
                .addField('Como jogar', "Reage à mensagem com emojis de letras ou que parecem letras (🅰️, 🇹, )")
                .setTimestamp();
    ...
    gameOver(win) {
        ...
        const editEmbed = new Discord.MessageEmbed()
            .setColor('#0099ff')
            .setTitle('Hangman')
            .setDescription((win ? "Chat Ganha!" : "Chat Perde!") + "\n\nA palavra era:\n" + this.word)
            .setTimestamp();
        this.gameEmbed.edit(editEmbed);
